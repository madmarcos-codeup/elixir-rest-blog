...
public class PostsController {
    ...
    private List<Post> getAll() {
        ...
        posts.add(new Post(1L, "Post 1", "Blah blah blah", USER1, Arrays.asList(CAT1, CAT2)));
        posts.add(new Post(2L, "Post 2", "Blah blah blah blah blah", USER2, Arrays.asList(CAT2, CAT3)));
        posts.add(new Post(3L, "Post 3", "Blah blah blah blah blah blah blah", USER1, Arrays.asList(CAT1, CAT3)));
        return posts;
    }
