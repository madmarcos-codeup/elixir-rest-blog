...
public class UsersController {
    ...
    private static final Post POST2 = new Post(2L, "Post 2", "Blah", null);
    private static final Post POST3 = new Post(3L, "Post 3", "Blah", null);
    private static final Post POST4 = new Post(4L, "Post 4", "Blah", null);
    private static final Post POST5 = new Post(5L, "Post 5", "Blah", null);
    private static final Post POST6 = new Post(6L, "Post 6", "Blah", null);
